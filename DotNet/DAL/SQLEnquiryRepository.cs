...
namespace DotNetComputerSekho.Models
{
    public class SQLEnquiryRepository : IEnquiryRepository
    {
        ...
        public Task<ActionResult<Enquiry>> GetByName(string name)
        {
        ...
        public Task<ActionResult<Enquiry>> getEnquiryByStaff(string staffName)
        {
            throw new NotImplementedException();
        }
        ...
        public Task<ActionResult<Enquiry>> updateprocessflag(int id)
        {
            throw new NotImplementedException();
        }
    }
